...
global{
	...
	init {
		...
		save road type:"shp" to:"../includes/roads_OSM.shp" with:[lanes::"lanes",maxspeed::"maxspeed", oneway::"oneway"] ;
		save intersection type:"shp" to:"../includes/nodes_OSM.shp" with:[type::"type", crossing::"crossing"] ;
